...
impl Client {
    ...
    pub fn activate_state(
        ...
        if !skip_boot {
            boot::synchronize(self, &new, None)?;
        }
    ...
    pub fn new_state(
        ...
        if let Some(ref callback) = progress_callback {
            callback(ProgressEvent::Stage(ProgressStage::Blit))
        }
    ...
    fn apply_triggers(
        ...
        if let Some(ref callback) = progress_callback {
            callback(ProgressEvent::Stage(phase))
        }
    ...
    pub fn apply_stateful_blit(
        ...
        boot::synchronize(self, state, progress_callback.clone())?;
