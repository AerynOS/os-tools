...
impl System {
    ...
    pub fn phases(&self) -> Phases {
        match self {
            ...
            System::PerlExtutilsMakefile => perl::perl_extutils_makefile::phases(),
            System::PerlModuleBuild => perl::perl_module_build::phases(),
        }
    }
    ...
    fn process(&self, state: &mut State<'_>, file: &File<'_>) -> Result<(), Error> {
        match self {
            ...
            System::PerlExtutilsMakefile => perl::perl_extutils_makefile::process(state, file),
            System::PerlModuleBuild => perl::perl_module_build::process(state, file),
        }
    }
}
